  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint1 = Paint()
      ..shader = ui.Gradient.radial(
        ...
        [
          ...
          EdenColors.presenceBlue.withValues(alpha: 0.045 + 0.015 * math.sin(angle1)),
          Colors.transparent,
        ],
      );
    ...
    final Paint paint2 = Paint()
      ..shader = ui.Gradient.radial(
        ...
        radius2,
        [
          EdenColors.warmViolet.withValues(alpha: 0.035 + 0.012 * math.cos(angle2)),
          Colors.transparent,
        ],
      );
    ...
    final Paint paint3 = Paint()
      ..shader = ui.Gradient.radial(
        ...
        radius3,
        [
          EdenColors.humanWarmth.withValues(alpha: 0.025 + 0.01 * math.sin(angle3)),
          Colors.transparent,
        ],
      );
