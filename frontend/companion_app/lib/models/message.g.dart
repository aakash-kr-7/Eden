...
void _messageSerialize(
  ...
  writer.writeString(offsets[2], object.emotionalSignal);
...
Message _messageDeserialize(
  ...
  final object = Message(
    ...
    emotionalSignal: reader.readStringOrNull(offsets[2]),
    id: id,
    role: _MessageroleValueEnumMap[reader.readByteOrNull(offsets[4])] ??
        MessageRole.user,
    sentAt: reader.readDateTime(offsets[5]),
  );
  return object;
}
